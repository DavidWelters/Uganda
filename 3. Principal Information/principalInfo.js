...
(function () {
  ...
  function makeSection(text, subtext) {
    ...
    d.innerHTML = text + (subtext
      ? ' <span style="font-size:10px;font-weight:400;text-transform:none;letter-spacing:0;margin-left:10px;color:#555;">' + subtext + '</span>'
      : '');
    return d;
  }
  ...
  var inputStyle = 'display:block;height:26px;width:100%;max-width:100%;box-sizing:border-box;' +
    'border:1px solid #bbb;border-radius:6px;padding:0 8px;font-size:12.5px;' +
    'font-family:Segoe UI,Arial,sans-serif;color:#1a1a1a;background:#fff;outline:none;box-shadow:none;';
  var selectStyle = inputStyle + 'height:28px;';
  var labelStyle = 'display:block;font-size:11.5px;font-weight:400;color:#1a1a1a;margin-bottom:2px;';
  ...
  function styleInputs(container) {
    ...
    container.querySelectorAll('input[type="text"],input[type="email"],select').forEach(function(el) {
      ...
      el.style.setProperty('border', '1px solid #bbb', 'important');
  ...
  function buildLayout() {
    ...
    uploadRow.style.setProperty('margin-top', '10px', 'important');

    /* ── PASSPORT THUMBNAIL PANEL ── */
    var passportPanel = document.createElement('div');
    passportPanel.id = 'pc-passport-panel';
    passportPanel.style.cssText = 'border:1px solid #ccc;border-radius:4px;padding:10px 12px;' +
      'background:#fafafa;font-family:Segoe UI,Arial,sans-serif;font-size:11px;';
    ...
    passportTitle.style.cssText = 'font-size:12px;font-weight:600;color:#1a1a1a;letter-spacing:0.02em;';
    var trashBtn = document.createElement('button');
    trashBtn.type = 'button';
    trashBtn.title = 'Remove';
    trashBtn.innerHTML = '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#999" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/><path d="M10 11v6M14 11v6"/><path d="M9 6V4h6v2"/></svg>';
    trashBtn.style.cssText = 'background:none;border:none;cursor:pointer;padding:2px;line-height:1;' +
    ...
    imgBox.style.cssText = 'width:100%;height:160px;border:1px solid #ddd;' +
      'background:#ebebeb;display:flex;align-items:center;justify-content:center;' +
      'overflow:hidden;flex-shrink:0;border-radius:3px;margin-bottom:8px;';
    ...
    photoPanel.style.cssText = 'border:1px solid #ccc;border-radius:4px;padding:10px 12px;' +
      'background:#fafafa;font-family:Segoe UI,Arial,sans-serif;font-size:11px;';
    ...
    photoTitle.style.cssText = 'font-size:12px;font-weight:600;color:#1a1a1a;letter-spacing:0.02em;';
    var photoTrashBtn = document.createElement('button');
    photoTrashBtn.type = 'button';
    photoTrashBtn.title = 'Remove';
    photoTrashBtn.innerHTML = '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#999" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/><path d="M10 11v6M14 11v6"/><path d="M9 6V4h6v2"/></svg>';
    photoTrashBtn.style.cssText = 'background:none;border:none;cursor:pointer;padding:2px;line-height:1;display:flex;align-items:center;opacity:0.6;';
    ...
    photoImgBox.style.cssText = 'width:100%;height:160px;border:1px solid #ddd;' +
      'background:#ebebeb;display:flex;align-items:center;justify-content:center;' +
    ...
    var uploadSlots = [
      { btnClass: '.uploadPassportBtn',     field: '#q83',               imgBox: imgBox,         label: 'Passport',      onUpdate: updatePassportPanel },
